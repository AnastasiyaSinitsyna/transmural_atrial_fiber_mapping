...
pa_ud = utils.read_array_igb(base_dir + "PA_UAC_1/phie.igb")[0]
ls_lr = utils.read_array_igb(base_dir + "LS_UAC_1/phie.igb")[0]
...
pts_src = utils.load_landmarks(base_dir + seed_name)
